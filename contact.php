...
<div class="main">
  <div id="center">
    ...
    <h2>  contact us </h2>
    <tr><td>
            phone_number:</td><td> +251577753239</td></tr>
    <tr><td>
  website:</td><td>  <a href="https://www.wu.edu.et" target="_blank">
<img src="image/wpu-logo-black.png" width="40" height="60" border="1" /> wu.edu.et
    </a></tr></td>
    
    <tr><td>
            twitter:</td><td> <a href="http://www.twitter.com/kiot" target="_blank">
        <img src="image/icon-twitter.gif" width="40" height="60" border="1" /> twitter
    </a></tr></td>
    <tr><td>
  facebook:</td><td>  <a href="http://www.facebook.com/kiot" target="_blank">
        <img src="image/icon-facebook.gif" width="40" height="60" border="1" /> facebook
    </a></tr></td>
    <tr><td> email:</td><td>   <a href="mailto:kiot@wu.edu.et"> kiot@kiot.edu.et </a></td></tr>
    </table>
    </div>
</div>
<div class="right">
