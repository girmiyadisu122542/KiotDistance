                    ...
                    <div style="padding:50px;margin-top:100px;background-color:background;height:1200px;">   
                        <div class="row">
                            ...
                            <div class="col-sm-9 body">
                                <h2 align="center"> Activate User Account</h2><div class="text-right">
                                ...
                                if (mysqli_num_rows($query) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($query)) {
                                        ...
                                        echo '<td><a class="btn btn-success" role="button" href="activateusers.php?uid=' . $row['Id'] . '"><i class="fa fa-edit"></i></a></td></tr>';
                                    }
                                    echo '</table>';
                                } else {
                                    echo '<div class="alert alert-info">There is no any Deactvated User account.</div>';
                                }
                                if (isset($_GET['uid'])) {
                                    $uid = $_GET['uid'];
                                    $query1 = mysqli_query($conn,"update account set Status='1' where Id='$uid'");
                                }
                                ?>
                            </div>
                        </div>
