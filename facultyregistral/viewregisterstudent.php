            ...
            <div class="row">
                ...
                <div class="col-sm-9 body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="department" class="form-control">
                                        <option value="default">..Select Departiment..</option>
                                        <?php
                    ...
                    if (isset($_POST['payid'])) {
                        ...
                        $stud = mysqli_query($conn,"select * from student_registration where Department='$department' and classyear='$classYear' and Status='0'");
